...
from completions import check_code_against_guidelines, check_for_breaking_changes, code_snippet_summary, explain_code_deltas
...
response = code_snippet_summary('TypeScript', code_snippet)
print(response)
